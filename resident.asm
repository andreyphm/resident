...
New09       proc
            ...
            xor bx, bx
            xor di, di                  ; BX = DI = Frame address on screen
            call WriteFrame
            call WriteRegisters
...
;----------------------------------------------------------------------
;Write registers value on the screen
;Arguments: DI = frame address on screen, BX = frame address on screen
;Return value: -
;Destroy: AX, BX
;----------------------------------------------------------------------
WriteRegisters      proc
...
WriteFrame      proc
                ...
                mov cx, 30              ; Set number of symbols in string
                mov si, cx
                sub si, 2
                call WriteTopLine

		        mov bx, di	            ; BX is now frame address
		        mov cx, 10 	            ; Set number of lines
		        call WritePillars
